...
public class SearchAdapter extends RecyclerView.Adapter{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        SearchHolder holder =new SearchHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_booklist,parent,false));
        return holder;
    }
    ...
    public void setFilter(List<Booklist> FilteredDataList) {
