...
public class OtherCommentAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        myHolder.tvBookname.setText(list.get(position).getBooklist().getName());
        myHolder.tvAuthor.setText(list.get(position).getBooklist().getAuthor());
        Glide.with(context).load(list.get(position).getBooklist().getCover()).into(myHolder.ivCover);
    }
