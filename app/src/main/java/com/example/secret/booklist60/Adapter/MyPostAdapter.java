...
//        System.out.println("onBindViewHolder----------");
        ...
        if (ground.getBooklist()!=null){
            myHolder.tvBookname.setText(ground.getBooklist().getName());
            myHolder.tvAuthor.setText(ground.getBooklist().getAuthor());
            myHolder.layoutbook.setVisibility(View.VISIBLE);
            Glide.with(context).load(ground.getBooklist().getCover()).into(myHolder.ivCover);
        }
