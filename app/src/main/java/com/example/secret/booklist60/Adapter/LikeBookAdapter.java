...
public class LikeBookAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LikeBookHolder holder =new LikeBookHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_booklist,parent,false));
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        Glide.with(context).load(list.get(position).getBooklist().getCover()).into(likeBookHolder.ivCover);
