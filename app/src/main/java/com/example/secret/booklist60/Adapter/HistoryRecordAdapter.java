...
public class HistoryRecordAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        HistoryRecordHolder holder =new HistoryRecordHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_booklist,parent,false));
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        String coverUrl = list.get(position).getBooklist().getCover();
        if (coverUrl!=null){
